...
const blank_hex  = "https://www.colorbook.io/imagecreator.php?hex=cbe5ec&width=1080&height=1920&text=%201080x1920"
...
const images = [
  ...
  <li className="item" key={index} style={image == blank_hex ? { borderColor: "#CBE5EC" } : null}>
