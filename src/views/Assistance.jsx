      ...
      <div className="wrapper">
        ...
        <div className="split_box">
          ...
          <div className="box_right_text">
            <h2>Why Go With Flexxbuy</h2>
            <br />
            <ul>
              <li>Financing for <b>All credit situations</b></li>
              <li><b>Buy now</b>, pay later</li>
              <li>Interest rates starting at <b>5.9%</b> with terms up to <b>144 months</b></li>
              <li>No long term contracts and <b>no cancellation fees</b></li>
              <li><b>Instant</b> decisions</li>
            </ul>
          </div>
        </div>
        {/* END SECTION 2 */}
